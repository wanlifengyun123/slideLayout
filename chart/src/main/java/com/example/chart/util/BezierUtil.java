...
public class BezierUtil {
    ...
    public static List<PointF> buildBezierPoint(List<PointF> controlPointList,
        ...
        for (float u = 0; u <= 1; u += delta) {
            pointList.add(new PointF(BezierUtil.calculatePointCoordinate(BezierUtil.X_TYPE, u, order, 0, controlPointList),
                    BezierUtil.calculatePointCoordinate(BezierUtil.Y_TYPE, u, order, 0, controlPointList)));
        }
